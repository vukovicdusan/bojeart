...
const About = () => {
  ...
  const authorFilterHandler = (authorKey) => (e) => {
    e.preventDefault();
    setFilter(authorKey);
  };

  const activeAuthor = filter === "jelena" ? "jelena" : "bojan";
      ...
      <div className="stack">
        ...
        <div className="[ wrap ] [ center ] [ center-row ]">
          <button
            ...
            onClick={authorFilterHandler("jelena")}
          >
            {t("authors.jelena.name")}
          </button>
          ...
          <button
            ...
            onClick={authorFilterHandler("bojan")}
          >
            {t("authors.bojan.name")}
          </button>
        </div>
        ...
        >
          ...
          <div>
            <h2>{t(`authors.${activeAuthor}.name`)}</h2>
            <p>{t(`authors.${activeAuthor}.bio`)}</p>
          </div>
        </div>
      </div>
    </Region>
