...
const Painting = (props) => {
  ...
  const openModal = () => {
    props.openModal(props.imgProp, true, "paintingModal");
  };
  //FILTER VARIABLES
  ...
  return (
    ...
    >
      ...
      <AnimationContainer>
        <div onClick={openModal} className={`${styles.imgWrapper} [ frame ]`}>
          <div className={styles.imgInfo}>
            <ClientOnly>
              <h4>{props.imgProp.imgName}</h4>
              <p className="text-clamp">
                {props.imgProp.year +
                  " - " +
                  props.imgProp.material +
                  " - " +
                  props.imgProp.dimensions}
              </p>
            </ClientOnly>
          </div>
          <Image
            ...
            alt={props.imgProp.imgName ?? "slika"}
            placeholder="blur"
